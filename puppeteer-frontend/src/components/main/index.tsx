            ...
            <div className="flex flex-col justify-center space-y-4 text-center">
              ...
              <div className="mx-auto w-full max-w-full space-y-4">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-1">
                  <div className='flex flex-col items-center space-y-2 rounder-lg p-4'>
                    <div className="rounded-full bg-black p-4 text-white">
                      <Rocket size={32} />
                    </div>
                    <h2 className="text-2xl font-bold text-white">{t('modernscraper')}</h2>
                    <p className="text-white">{t('modernscraper-desc')}</p>
                  </div>
